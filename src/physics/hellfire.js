    ...
    constructor(gameObject){
        ...
        this.gameObject.subscribe("keydown", (event) => {            
            switch (event.code){
                ...
                case "KeyS": this.wing_lift   = -steering_lift; break;
                case "KeyA": this.rudder_lift = -steering_lift; break;
                case "KeyD": this.rudder_lift =  steering_lift; break;
            }
        });

        this.gameObject.subscribe("keyup", (event) => {
            switch (event.code){
                case "KeyW": this.wing_lift   = 0; break;
                case "KeyS": this.wing_lift   = 0; break;
                case "KeyA": this.rudder_lift = 0; break;
                case "KeyD": this.rudder_lift = 0; break;
            }
        });
    }
}
